...
class Net(nn.Module):
    def __init__(self,FILTER_LENGTH1,NUM_FILTERS,FILTER_LENGTH12):
        ...
        torch.nn.init.xavier_uniform(self.fc3)
        self.fc4= nn.Linear(512,1,)
        torch.nn.init.xavier_uniform(self.fc4)
