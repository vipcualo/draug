...
from keras.layers import Dense, Dropout, Activation, merge as Merge
...
def build_combined_categorical(FLAGS, NUM_FILTERS, FILTER_LENGTH1, FILTER_LENGTH2):
    ...
    print("1 ,charsmiset_size ",FLAGS.charsmiset_size)
    print("2, charseqset_size ",FLAGS.charseqset_size)
...
if __name__=="__main__":
    ...
    FLAGS.log_dir="/home/tainv/tmp1545016336.2369363/"
